    ...
    return (
        <SidebarProvider defaultOpen={uiSettings.sidebarOpen}>
            ...
            <main className="flex-1 overflow-hidden h-screen flex flex-col bg-background">
                <header className="flex h-14 shrink-0 items-center gap-2 border-b px-4 bg-background/80 backdrop-blur-sm transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
