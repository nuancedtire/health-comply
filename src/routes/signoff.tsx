...
function SignoffPage() {
    ...
    if (isSiteLoading) {
        return <MainLayout title="Sign-off"><div className="p-8">Loading...</div></MainLayout>;
    }
    ...
    return (
        <MainLayout title="Document Sign-off">
            <div className="space-y-8">
                {/* Header */}
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Document Sign-off</h2>
                                        ...
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell>
                                                <span className="text-sm text-muted-foreground">
                                                    {item.localControl?.title || item.suggestedControl?.title || "Unassigned"}
                                                </span>
                                            </TableCell>
                                            <TableCell>
                                                <div className="flex items-center gap-2">
            ...
            <AlertDialog open={approveDialogOpen} onOpenChange={setApproveDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            You are about to approve "{selectedEvidence?.title}". This will mark
                            the evidence as verified for compliance purposes.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="py-4">
