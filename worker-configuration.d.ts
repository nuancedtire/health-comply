/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: bda4c1fb7a0faa62024a2d9490c292ab)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		EVIDENCE_INGEST: Workflow<Parameters<import("./src/server").EvidenceIngestWorkflow['run']>[0]['payload']>;
	}
}
