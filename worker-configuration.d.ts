/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: e60be7d0c192f0af2d5ebbd8557b76fb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CHAT_AGENT: DurableObjectNamespace<import("./src/server").ChatAgent>;
		R2: R2Bucket;
		DB: D1Database;
		AI: Ai;
		EVIDENCE_INGEST_WORKFLOW: Workflow<Parameters<import("./src/server").EvidenceIngestWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "EXA_API_KEY" | "CEREBRAS_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS">> {}
}
